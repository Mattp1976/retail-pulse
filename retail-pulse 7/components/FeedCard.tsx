      ...
      <div className="flex items-start gap-3">
        <div className="min-w-[72px] text-center">
          <div className="rounded-xl border border-line bg-white/90 px-2 py-2">
            <p className="text-[10px] uppercase tracking-wide text-slate">Impact</p>
            <p className="mt-1 text-xl font-semibold text-ink">{e?.impact_score ?? "-"}</p>
          </div>
          <div className="mt-2 text-[11px] text-slate">
            <p>Horizon: {e?.time_horizon ?? "-"}</p>
        ...
        <div className="flex-1">
          ...
          <h3 className="mt-1 text-[17px] font-semibold text-ink">{item.title}</h3>
          <p className="mt-1 text-[13px] text-slate">{e?.what_happened}</p>
          <p className="mt-1 text-[13px] text-slate">{e?.why_it_matters_operator}</p>
